...
const Hero = () => {
  return (
    <div>
        <div className='my-7 sm:my-0 max-w-[1200px] h-[80vh] mx-auto flex flex-col-reverse md:flex-row
                         justify-center align-center'id='home'>
                            ...
                            <div className="relative inline-flex group my-3">
                                <div className="absolute duration-1000 opacity-70 -inset-px bg-gradient-to-r 
                            ...
                            font-bold text-white duration-200 bg-primary-color rounded-xl">Download CV
                            </a>
                         </div>
                          </div>
