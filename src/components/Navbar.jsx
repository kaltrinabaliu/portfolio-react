    ...
    <div>
      <div className='text-gray-500 flex justify-between items-center max-w-[1240px] mx-auto h-24 px-4 text-lg'>
       ...
       <div onClick={handleNav} className='block md:hidden'>
        ...
        <div className={nav ? 'z-10 text-gray-300 fixed h-full left-0 top-0 w-[63%] border-r border-r-gray-900 bg-[#202121] ease-in-out duration-500'
        :'fixed left-[-100%]'}>
        <h1 className='text-3xl font-bold primary-color m-4'>A.PARK</h1>
