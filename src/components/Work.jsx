  ...
  return (
    <div className="py-6 max-w-[1200px] mx-auto" id='work'>
        <div className="mx-auto px-4 md:px-8">
            ...
            <div className="grid gap-3 md:grid-cols-3 sm:grid-cols-1 sm:gap-3 md:gap-6 xl:gap-8">
                <a href="/" className="group h-48 overflow-hidden rounded-lg md:h-80">
                    <img src={proj1} alt="" className="h-full w-full object-cover object-center transition
                                                    duration-200 group-hover:scale-110" />
                </a>
                <a href="/" className="group h-48 overflow-hidden rounded-lg md:col-span-2 md:h-80">
